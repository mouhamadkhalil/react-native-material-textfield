...
import { TripStackNavigator, MyBookingStackNavigator, MoreStackNavigator, ContactStackNavigator, AllGamesStackNavigator , WhereToEatStackNavigator} from "./StackNavigator";
...
const WhereToEatTabs = ({ navigation }) => {
    return (
        <Tab.Navigator initialRouteName= "book a trip" screenOptions={({ route }) => ({
            tabBarIcon: ({ focused, color, size }) => {
                if (route.name === 'book a trip') {
...
export {TripTabs, BookingsTabs, MoreTabs, ContactTabs, AllGamesTabs, WhereToEatTabs};