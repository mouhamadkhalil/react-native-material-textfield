...
export default class ChatHome12Screen extends React.Component {

  Back = () => {
    this.props.navigation.navigate('Chat Home 10 Screen');
  }
      ...
      <ScrollView style={styles.container}>
        ...
        <ScrollView style={{ width: "50%", height: 700, backgroundColor: "#F9F4EC" }}>
          <ScrollView>
            ...
            <Image
              source={User}
              style={{ marginLeft: 30, marginTop: 35, width: 25, height: 25 }}
            />
            <Text
              style={{
                marginLeft: 90,
            ...
            <Image
              source={User}
              style={{ marginLeft: 30, marginTop: 10, width: 25, height: 25 }}
            />
            <Text
              style={{
                marginLeft: 90,
